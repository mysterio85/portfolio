 ...
 */
class Categorie extends \Website\WebsiteBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Website\\WebsiteBundle\\Entity\\Categorie' . "\0" . 'idcategorie', '' . "\0" . 'Website\\WebsiteBundle\\Entity\\Categorie' . "\0" . 'libelle');
        }
